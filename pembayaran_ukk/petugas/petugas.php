...
<div class="container mt-5">
	...
	<a href="petugas.php" class="btn btn-primary"> Administrator</a>	
	...
	<div class="card mt-2">
		<div class="card body">
			...
			if(empty($file)){
				...
				echo "Aplikasi Pembayaran SPP digunakan untuk mempermudah untuk mencatat Pembayaran Siswa/i di Sekolah";
